...
const sortFunc = (elem1, elem2) => {
    const monyear1 = elem1[0];
    const monyear2 = elem2[0];

    const yearmon1 = monyear1.substring(2, 4) + monyear1.substring(0, 2);
    const yearmon2 = monyear2.substring(2, 4) + monyear2.substring(0, 2);
...
const sorted = fixedNames.sort(sortFunc);
